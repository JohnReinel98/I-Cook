...
public class ChickTapaFragment extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ChickTapaFragment.ViewPagerAdapter adapter = new ChickTapaFragment.ViewPagerAdapter(getChildFragmentManager());
        adapter.addFragment(new ChickTapaIngredients(), "Ingredients");
        adapter.addFragment(new ChickTapaProcedures(), "Procedures");
